...
# 🎯 Processo de Produto — Do Estratégico ao Tático

> [!abstract] Resumo
> Framework de gestão de produto com ciclos trimestrais, planejamento anual, revisões semestrais, e execução por squads. Aplicável a múltiplas tribos com PMs reportando ao Head de Produto.
...
| Fase | Nota | Quando |
|------|------|--------|
| 🎯 Estratégico | [[1- Planejamento Anual]] | Janeiro |
| 🔄 Revisão | [[2- Revisão Semestral]] | Julho |
| 📦 Trimestral | [[3- Ciclo Trimestral]] | Q1-Q4 |
| ⚡ Execução | [[4- Execução Semanal]] | Toda semana |
| 👥 Governança | [[6- Governança RACI]] | Referência |
...
> - **Anual**: Visão → Estratégia → Big Rocks (3-5 apostas) → OKRs
> - **Semestral**: Avaliar Big Rocks → Dobrar/Pivotar/Cortar → Recalibrar
...
> - **Governança**: Head decide estratégia; PM decide tática; Squad executa

---

> [!note] Sobre este processo
> Agnóstico de framework de delivery. Squads podem usar Scrum, Kanban, Shape Up ou qualquer outro. Este processo é a **camada de governança e direcionamento** acima do framework escolhido.
