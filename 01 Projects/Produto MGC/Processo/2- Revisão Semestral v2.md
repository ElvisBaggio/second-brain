...
# 🔄 Revisão Semestral v2 (Julho)

> [!abstract] Objetivo
> Avaliar progresso das Big Rocks, ajustar estratégia com base em aprendizados, reavaliar Topologia e Headcount de Pilares, e recalibrar OKRs para o segundo semestre.
...
### Semana 2 — Ajustes Estratégicos & Topologia
- Decisão por Big Rock: **Dobrar ↑ | Manter → | Pivotar ↻ | Cortar ✕**
- Recalibração de OKRs para S2
- **Análise de Topologia/Headcount:** Verificar gaps de alocação de PMs/PDs e rebalanceamento de escopos
- Ajuste de alocação de recursos entre pilares
...
- [ ] Topologia e Headcount de Pilares reavaliados (vagas endereçadas)
- [ ] Alocação de recursos revisada entre pilares
- [ ] Mudanças comunicadas para a organização
- [ ] Learnings documentados

---

Ver também: [[1- Planejamento Anual v2]] · [[3- Ciclo Trimestral]] · [[Template - Revisão de Big Rock]]
